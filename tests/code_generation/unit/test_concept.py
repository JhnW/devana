...
from devana.code_generation.printers.default.classprinter import ClassPrinter, FieldPrinter
...
from devana.syntax_abstraction.classinfo import ClassInfo, FieldInfo
...
""")
    ...
    def test_print_complex_concept_class(self):
        ...
        result = self.printer.print(class_)
        self.assertEqual(result, """template<DefaultConcept<int> T> requires true
...
class TestConceptFunction(unittest.TestCase):
    ...
    def test_function_requires(self):
        ...
        self.assertEqual(result, "template<typename T> requires Concept<T>\nvoid foo();\n")
